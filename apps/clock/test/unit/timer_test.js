...
suite('Timer', function() {
  var as, al, now, startAt, endAt, duration, minute, past;
  ...
  suite('Timer.Panel', function() {
    test('shape:prototype ', function() {
      ...
      assert.ok(Timer.Panel.prototype.handleEvent);
    });

    test('shape:instance ', function() {
      var panel = Timer.init();
  ...
  suite('Timer.Panel, Events', function() {
    ...
    setup(function() {
      this.sinon.spy(panel, 'handleEvent');
    ...
    test('click: start ', function() {
      ...
      assert.ok(panel.handleEvent.called);
    ...
    test('click: cancel ', function() {
      ...
      assert.ok(panel.handleEvent.called);
      assert.ok(panel.timer.cancel.called);
    });
  });
});
